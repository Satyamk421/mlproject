...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            num_data = ['writing_score','reading_score']
            cat_data = ['gender','race_ethnicity','parental_level_of_education','lunch','test_preparation_course']
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info('ad the test and train data')
